    ...
    <div class="flex w-full items-center justify-between h-16 px-6 lg:px-8">
      ...
      <div :class="{ 'hidden md:flex': !openMenu }"
        ...
        <template v-else>
          ...
          <router-link to="/register" class="btn1">
            Register
          </router-link>
        </template>
      </div>
